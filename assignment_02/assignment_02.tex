...
\rowcolor{blue!30}
 & IN[B] & OUT[B] \\
\hline
BB1 & $\emptyset$ & $\emptyset$ (\textbf{boundary condition}) \\
\hline
...
L'algoritmo arriva a convergenza all'iterazione 3 (notiamo in particolare che dalla seconda iterazione non cambia \lstinline|IN[BB9]|, ovvero l'input del blocco \lstinline|WHILE|, unico ad avere predecessori multipli).
